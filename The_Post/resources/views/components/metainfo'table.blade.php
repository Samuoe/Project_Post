        ...
        <tr>
            ...
            <td>
                <form action="{{route('admin.editTag', ['tag'=> $metaInfo])}}" method="POST">
                    ...
                    <button type="sunmit" class="btn btn-info text-white">Aggiorna</button>
                </form>
            </td>
            <td>
                <form action="{{route('admin.deleteTag', ['tag'=> $metaInfo])}}" method="POST">
                    @csrf
                    @method('delete')
                    <button type="sunmit" class="btn btn-danger text-white">Elimina</button>
                </form>
            </td>
